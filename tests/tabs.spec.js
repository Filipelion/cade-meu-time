...
test.describe('Tab switching', () => {
  ...
  test('clicking Notícias activates its content', async ({ page, extensionId }) => {
    await setup(page, extensionId);
  ...
  test('clicking Vídeos activates its content', async ({ page, extensionId }) => {
    await setup(page, extensionId);
  ...
  test('switching tabs deactivates previous tab', async ({ page, extensionId }) => {
    await setup(page, extensionId);
    await page.click('#tab-news');
    await page.click('#tab-videos');
    await expect(page.locator('#tab-videos')).toHaveClass(/active/);
